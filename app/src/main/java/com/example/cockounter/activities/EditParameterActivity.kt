...
import com.example.cockounter.core.ParameterType
...
class EditParameterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = if (parameter == null) {
            ViewModelProviders.of(this).get(EditParameterViewModel::class.java)
        } else {
        ...
        EditParameterUI(
            viewModel.visibleName,
            viewModel.name,
            viewModel.typePosition,
    ...
    private fun updateVisibleName(visibleName: String) {
    ...
    private fun updateInitialValue(initialValue: String) {
        viewModel.initialValue = initialValue
    }

    private fun updateType(type: ParameterType, position: Int) {
        viewModel.type = type
    ...
    private fun changeScript(index: Int) {
    ...
    private class EditParameterUI(
        val visibleName: String,
        val name: String,
        val typePosition: Int,
        val initialValue: String,
        private val scriptsAdapter: ListAdapter
    ) :
        ...
        override fun createView(ui: AnkoContext<EditParameterActivity>): View = with(ui) {
            coordinatorLayout {
                ...
                verticalLayout {
                    ...
                    val typeAdapter =
                        ArrayAdapter(context, android.R.layout.simple_spinner_item, ParameterType.values())
                    spinner {
                        adapter = typeAdapter
